...
public enum Error {
    ...
    INVALID_NICKNAME("user with nickname N_N already notExists"),
    INVALID_USERNAME("user with username U_N already notExists"),
    ...
    // DeckMenu errors:
    REPETITIOUS_DECK_NAME("deck with name %s already notExists"),
